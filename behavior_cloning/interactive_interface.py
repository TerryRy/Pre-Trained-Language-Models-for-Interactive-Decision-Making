...
def sample_action(args, obs, agent_id, action_logits, object_logits, all_actions, all_cur_observation, logging):
    ...
    while 1:
        if agent_action==None or agent_obj==None or agent_obj>=len(graph_nodes):
            ...
            bad_action_flag_v2, ignore_walk = utils_interactive_eval.check_logical_before_unity(agent_id, cur_action=action_obj_str, actions_sofar=all_actions, observations_sofar=all_cur_observation, logging=logging, verbose=False)
